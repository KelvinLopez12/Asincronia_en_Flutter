...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Practica asincronia en flutter kelvin',
      debugShowCheckedModeBanner: false,
      theme: ThemeData(
        primarySwatch: Colors.yellow,
      ),
      home: const MyHomePage(title: 'Practica asincronia en flutter kelvin'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Color _containerColor1 = Colors.pink;

  double _containerWidth2 = 0;
  double _containerHeigth2 = 0;
  Color _containerColor2 = Colors.pink;
